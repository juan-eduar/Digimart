      ...
      <div class="container-fluid header hvr-shadow">
        <header id="header" class="">
          <div class="padding__general main-navbar__contentop "> 
            <div class="logo">
              <a href="index.html"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/logo-digimart-negro.png" alt="Digimart"></a>
            </div>
    ...
    <div class="row">
      <div class="contenedor-images">
        <div class="col-lg-4 image-nosotros">
          <img class="img-nosotros" src="<?php echo get_template_directory_uri(); ?>/assets/img/image1.jpeg" alt="">
        </div>
        <div class="col-lg-4 image-nosotros">
          <img class="img-nosotros" src="<?php echo get_template_directory_uri(); ?>/assets/img/image2.jpeg" alt="">
        </div>
        <div class="col-lg-4 image-nosotros">
          <img class="img-nosotros" src="<?php echo get_template_directory_uri(); ?>/assets/img/image3.jpeg" alt="">
        </div>
      </div>
    </div>
  </div>
